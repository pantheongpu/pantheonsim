// GENERATED -- entry points cufft exports that VirtualGPU does not implement.
//
...
void vgpu_report_unimplemented(const char* fn) {
  ...
  std::fprintf(stderr,
               "[vgpu] %s is not implemented by VirtualGPU; returning CUFFT_NOT_SUPPORTED.\n"
               "       The call site will see a failure rather than a wrong answer.\n", fn);
}
}  // namespace

VGPU_EXPORT int cufftXtExec() { vgpu_report_unimplemented("cufftXtExec"); return 16; }
VGPU_EXPORT int cufftXtMakePlanMany() { vgpu_report_unimplemented("cufftXtMakePlanMany"); return 16; }
