...
"""Turn a rocminfo/rocm-smi dump into a VirtualGPU device profile.
    ...
    amd/tools/characterize-do.sh gpu-mi325x1-256gb tor1
    amd/tools/rocminfo-to-profile.py /tmp/vgpu-cloud/gpu-mi325x1-256gb.rocminfo.txt
...
def main():
    ...
    out.append("# Generated by amd/tools/rocminfo-to-profile.py from a physical device.")
