...
typedef enum {
  ...
  /* AMD's (hsa.h). */
  HSA_AMD_SYSTEM_INFO_BUILD_VERSION = 0x200, /* const char*: the runtime's build */
  ...
  HSA_AMD_SYSTEM_INFO_EXT_VERSION_MAJOR = 0x207, /* uint16_t */
  HSA_AMD_SYSTEM_INFO_EXT_VERSION_MINOR = 0x208  /* uint16_t */
} hsa_system_info_t;
...
typedef struct hsa_amd_clock_counters_s {
  uint64_t gpu_clock_counter, cpu_clock_counter, system_clock_counter, system_clock_frequency;
