#!/usr/bin/env bash
# Intrinsics and builtins the PTX probe turned up, checked for what they compute.
#
...
src="$root/nvidia/tests/e2e/device_intrinsics.cu"
out="${TMPDIR:-/tmp}/vgpu_e2e_devintrin_$$"
